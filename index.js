...
const run = async()=>{
    try{
        ...
        const database = client.db("Motorcycle-Park");
        const touristCollection = database.collection("Products");
        ...
        app.put('users/admin', async(req, res)=>{
            ...
            const updeteDco ={$set: {rol:'admin'}};
            const result = await userCollection.updateOne(filter,updeteDco)
            res.json(result);
        })
